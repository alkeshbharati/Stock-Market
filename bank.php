...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $query="insert into bank(account,routing,amount) values('".$account."','".$routing."','".$amount."')";
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="wrap-input100 validate-input">
                ...
                <input type="text" name="account" class="input100" value="<?php echo $username; ?>" placeholder="Account Number">
            ...
            <div class="wrap-input100 rs1 validate-input">
                ...
                <input type="text" name="routing" class="input100" placeholder="Routing Number">
